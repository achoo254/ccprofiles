...
const { getActiveProfile, getAuthStatus } = require('./profile-commands.cjs');
...
module.exports = {
  cmdWhoami, cmdCheck, cmdClone, cmdSetup, cmdUninstall, showHelp
};
