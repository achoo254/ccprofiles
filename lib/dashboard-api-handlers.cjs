...
const { getActiveProfile, setActiveProfile, backupBase, getAuthStatus, getCredentialExtras, getConfiguredModel, getUsageLimits } = require('./profile-commands.cjs');
...
/** GET /api/usage — fetch usage limits (cache-first, API fallback) */
...
module.exports = {
  ...
  handleSwitchProfile, handleSaveProfile, handleDeleteProfile, handleUsage
};
